...
const Blog = () => {
  ...
  const tags = [
    ...
    { id: "ia", label: "Inteligência Artificial", count: 8 },
    { id: "web", label: "Desenvolvimento Web", count: 6 },
    { id: "mobile", label: "Mobile", count: 4 },
    { id: "cloud", label: "Cloud Computing", count: 3 },
    { id: "seguranca", label: "Segurança", count: 3 }
  ];
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 glass rounded-full border-0 focus:outline-none focus:ring-2 focus:ring-primary/50 text-foreground placeholder-muted-foreground"
              />
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map((post, index) => (
              <article
                key={post.id}
                className="group glass rounded-2xl overflow-hidden hover:scale-105 transition-all duration-500 cursor-pointer animate-fade-scale"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 glass rounded-full border-0 focus:outline-none focus:ring-2 focus:ring-primary/50 text-foreground placeholder-muted-foreground"
            />
