  ...
  const services = [
    {
      ...
      benefits: [
        "Aumento de até 300% no tempo de permanência dos usuários no site",
        "Melhoria significativa na taxa de conversão e vendas online",
        "Otimização completa para mecanismos de busca (SEO)",
        "Responsividade total em todos os dispositivos",
        "Carregamento ultra-rápido com otimização de performance",
      ...
      ideal: [
        "Empresas que precisam de presença digital forte",
        "E-commerces que querem aumentar vendas",
        "Startups buscando validação de mercado",
        "Organizações que precisam modernizar sistemas legados"
      ],
      results: [
        "Redução de 60% no tempo de carregamento",
        "Aumento de 150% na taxa de conversão",
        "Melhoria de 200% no ranking de SEO",
        "Crescimento de 80% no engajamento do usuário"
      ],
      price: "Sob consulta",
    ...
    },
    {
      ...
      benefits: [
        "Acesso direto aos recursos nativos do dispositivo",
        "Performance superior e experiência fluida",
        "Integração com notificações push para engajamento",
        "Funcionamento offline para maior conveniência",
        "Monetização através de compras in-app",
        "Analytics detalhados sobre comportamento do usuário"
      ],
      features: [
      ...
      ideal: [
        "Empresas que querem mobilidade para seus serviços",
        "Startups com foco mobile-first",
        "Negócios que precisam de engajamento constante",
        "Organizações que querem otimizar processos internos"
      ],
      results: [
        "Aumento de 250% no engajamento do usuário",
        "Redução de 40% nos custos operacionais",
        "Crescimento de 180% na retenção de clientes",
    ...
    },
    {
      ...
      benefits: [
        "Automatização completa de processos manuais",
        "Sincronização em tempo real entre sistemas",
        "Redução drástica de erros operacionais",
        "Escalabilidade automática conforme demanda",
        "Integração com principais ERPs e CRMs do mercado",
      ...
      ideal: [
        "Empresas com múltiplos sistemas desconectados",
        "E-commerces que precisam integrar marketplaces",
        "Organizações que querem automatizar workflows",
        "Negócios que dependem de sincronização de dados"
      ],
      results: [
        "Redução de 70% no tempo de processamento",
        "Eliminação de 95% dos erros manuais",
        "Aumento de 400% na eficiência operacional",
        "Economia de 50% nos custos de operação"
      ],
      price: "Sob consulta",
    ...
    },
    {
      ...
      benefits: [
        ...
        "Redução do tempo de aprendizado dos usuários",
        "Melhoria na satisfação e retenção de clientes",
        "Diferenciação competitiva através do design",
      ...
      ideal: [
        "Empresas que querem se destacar visualmente",
        "Produtos digitais que precisam de diferenciação",
        "Startups buscando identidade visual forte",
        "Negócios que querem melhorar experiência do usuário"
      ],
      results: [
        "Aumento de 180% na taxa de conversão",
        "Redução de 50% na taxa de abandono",
        "Melhoria de 250% na satisfação do usuário",
        "Crescimento de 120% no tempo de sessão"
      ],
      price: "Sob consulta",
    ...
    },
    {
      ...
      benefits: [
        "Automatização de processos repetitivos e complexos",
        ...
        "Personalização em massa da experiência do usuário",
      ...
      ideal: [
        ...
        "Negócios que querem automatizar atendimento",
        "Organizações que precisam de análises preditivas",
        "Startups focadas em inovação tecnológica"
      ],
      results: [
        "Redução de 80% no tempo de processamento",
        "Aumento de 300% na precisão de previsões",
        "Economia de 60% nos custos de atendimento",
        "Melhoria de 200% na eficiência operacional"
      ],
      price: "Sob consulta",
    ...
    },
    {
      ...
      benefits: [
        "Escalabilidade automática conforme demanda",
        "Redução drástica de downtime e indisponibilidade",
        "Backup automatizado e recuperação de desastres",
        "Monitoramento 24/7 com alertas proativos",
        "Deploy automatizado e rollback instantâneo",
        "Segurança enterprise com compliance regulatório"
      ],
      features: [
        "AWS, Azure, GCP",
        "Docker & Kubernetes",
      ...
      ideal: [
        "Empresas que precisam de alta disponibilidade",
        "Startups que querem escalabilidade automática",
        "Organizações com compliance rigoroso",
        "Negócios que querem reduzir custos de infraestrutura"
      ],
      results: [
        "Redução de 90% no downtime",
        "Economia de 40% nos custos de infraestrutura",
        "Aumento de 500% na velocidade de deploy",
        "Melhoria de 99.9% na disponibilidade do sistema"
      ],
      price: "Sob consulta",
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {services.map((service, index) => (
              <div
                key={service.title}
                className="group glass rounded-3xl overflow-hidden hover:scale-[1.02] transition-all duration-500 animate-fade-scale"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {process.map((item, index) => (
              <div
                key={item.step}
                className="relative text-center space-y-4 animate-fade-scale"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className="relative inline-block">
                  ...
                  {index < process.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 left-full w-full h-px bg-gradient-to-r from-primary/50 to-transparent transform -translate-y-1/2" />
                  )}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {[
              ...
              "Python", "Flutter", "AWS", "Docker",
              "GraphQL", "MongoDB", "PostgreSQL", "Redis",
              "Kubernetes", "TensorFlow", "Firebase", "Next.js"
            ].map((tech, index) => (
              <div
                key={tech}
                className="glass p-4 rounded-xl text-center hover:scale-105 hover:border-primary/50 transition-all duration-300 animate-fade-scale"
