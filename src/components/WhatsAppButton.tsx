...
const WhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 text-green-500 hover:text-green-400 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center group hover:scale-110 glow-green backdrop-blur-lg"
